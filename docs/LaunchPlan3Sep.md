...
| 5A — Failure harness | Production drills cover 429/5xx backoff, accepted-then-timeout idempotency, permanent failures and post-fan-out approval mutation; delayed campaign delivery now recomputes approval immediately before rendering/provider access | Stage 5 | Provider + approval drills done; queue/database/webhook/consent drills remain |
