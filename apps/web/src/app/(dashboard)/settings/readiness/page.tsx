...
export default function SetupReadinessPage() {
  ...
  if (!storeId) {
    return (
      <div className="mx-auto max-w-2xl py-12">
        ...
        <Link href="/dashboard" className="mt-5 inline-flex text-sm font-medium text-[#1F7A4F]">Return to home</Link>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto w-full max-w-3xl py-4 sm:py-8">
      ...
      <div className="mt-6"><Link href="/dashboard" className="text-sm font-medium text-[#1F7A4F]">← Return to dashboard</Link></div>
    </div>
  );
}
