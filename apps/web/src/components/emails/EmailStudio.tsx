      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        >
          ...
          <div className="min-h-0 flex-1 overflow-y-auto">
            ...
            {activeTab === "inspect" ? <InspectorPanel selected={selected} updateBlock={updateBlock} assets={creativeAssets} products={productPage?.products ?? []} onOpenVisuals={() => setActiveTab("visuals")} /> : null}
...
function InspectorPanel({ selected, updateBlock, assets, products, onOpenVisuals }: { selected: EmailBlock | null; updateBlock: (block: EmailBlock) => void; assets: Array<{ id: string; fileName: string; type: string; url?: string }>; onOpenVisuals?: () => void; products: Array<{ id: string; title: string; description?: string | null; imageUrl?: string | null; price: number; handle: string }> }) {
