    ...
    <div className="flex flex-col gap-4 h-[calc(100vh-7rem)] min-h-[640px]">
      ...
      <header className="shrink-0">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-decision">
          ...
          {templateId ? (
            <button
              ...
              className="shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-[12px] font-sans font-medium text-white bg-decision hover:bg-[var(--color-accent-hover)] disabled:opacity-50 transition-colors"
            >
        ...
        <div className={cn(
          ...
          <section className="rounded-xl border border-border bg-card p-4">
            <div className="flex items-center gap-2 mb-2">
              <Wand2 className="w-4 h-4 text-decision" />
            ...
            <div className="flex items-center justify-between mt-2 gap-3">
              <div className="flex items-center gap-3">
                ...
                {history.length > 0 ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-decision/40 text-[11px] font-sans font-medium text-decision hover:bg-decision/10 transition-colors"
                  >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-sans font-medium text-white bg-decision hover:bg-[var(--color-accent-hover)] disabled:opacity-50 transition-colors"
              >
                {promptMut.isPending ? (
          ...
          <section className="rounded-xl border border-border bg-card p-4 space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 rounded-lg border border-border bg-background text-[13px] font-sans text-foreground focus:outline-none focus:ring-1 focus:ring-decision"
            />
          </section>
          ...
          <section className="rounded-xl border border-border bg-card">
            <div className="flex items-center justify-between px-4 py-3 border-b border-border">
              <div className="flex items-center gap-2">
                <Pencil className="w-4 h-4 text-decision" />
                <h2 className="text-[11px] font-mono uppercase tracking-[0.14em] text-foreground">
                  Blocks
                </h2>
              </div>
              <button
                ...
                className="inline-flex items-center gap-1 text-[12px] font-sans text-decision hover:underline"
              >
              ...
              <div className="flex flex-wrap gap-1.5 px-4 py-3 border-b border-border bg-background/40">
                {ADDABLE.map((a) => (
                  <button
                    ...
                    type="button"
                    onClick={() => add(a.type)}
                    className="px-2.5 py-1 rounded-md border border-border text-[12px] font-sans text-foreground hover:border-decision hover:text-decision transition-colors"
                  >
                    {a.label}
                  </button>
                ))}
